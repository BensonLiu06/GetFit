...
def createAppWindow(mainWindow, userLoginWindow, dbConnection, dbCursor, username):
    ...
    # Create button widget for Workouts
    workoutsButton = ttk.Button(bottomFrame, text = "Workouts", command = lambda : createWorkoutWindow(mainWindow, appWindow, dbConnection, dbCursor, username))
